...
\begin{table}[!h]
\begin{tabular}{p{3.2cm}lp{1.8cm}}\toprule
...
\begin{table}[!h]
\begin{tabular}{p{4.2cm}p{2.5cm}}\toprule
...
\begin{figure*}
\includegraphics[scale=0.37]{gfx/ndcg3_winnum}
...
\begin{figure*}
\includegraphics[scale=0.37]{gfx/ndcg5_winnum}
...
\subsection{NDCG@10}
\begin{figure*}
\includegraphics[scale=0.37]{gfx/ndcg10_winnum}
...
\begin{figure*}
\includegraphics[scale=0.37]{gfx/map_winnum}
