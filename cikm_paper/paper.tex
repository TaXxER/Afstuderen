...
In recent years, several learning to rank benchmark datasets have been proposed with the aim of enabling comparison of the performance of different learning to rank methods. Well-known benchmark datasets in the learning to rank field include the \emph{Yahoo! Learning to Rank Challenge} dataset \cite{Chapelle2011a}, the Yandex Internet Mathematics competition\footnote{http://imat-relpred.yandex.ru/en/}, the LETOR dataset \cite{Qin2010}, and LETOR's successor the MSLR (Microsoft Learning to Rank) datasets.\\

No agreement exists between authors in the learning to rank field on the benchmark sets used for model evaluation. Comparing ranking performance of learning to rank methods is largely hindered by this lack of a \emph{de facto} standard way of benchmarking new models.

Several studies make a small start in considering learning to rank methods performance over multiple benchmark datasets. Gomes et al. \cite{Gomes2013} analysed ranking accuracy of a set of models on both LETOR 3.0 and LETOR 4.0. Busa-Fekete et al. \cite{Busa-Fekete2013} compared the accuracy of a small set of models over the LETOR 4.0 datasets, both MSLR datasets, both Yahoo! Learning to Rank Challenge datasets and one of the datasets from LETOR 3.0.\\

To our knowledge, no structured meta-analysis on ranking accuracy has been conducted where evaluation results on several benchmark collections are taken into account. In this paper we will perform a meta-analysis with the aim of comparing the ranking accuracy of learning to rank methods. 

\section{Collecting Evaluation Results}

\subsection{Evaluation Results Collection Methodology}
...
\subsection{Comparison Methodology of Learning to Rank Methods}
...
\subsection{Collection of Evaluation Results}
...
\subsection{Comparison of Learning to Rank models}
...
\begin{longtable}[!h]{@{}lrrrrrrrrrrrrrrrr@{}}\toprule
