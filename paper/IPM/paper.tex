...
\author[avanade,tue]{Niek Tax\corref{cor}\fnref{fn}}
\ead{n.tax@tue.nl}
\author[avanade]{Sander Bockting}
\ead{sander.bockting@avanade.com}
\author[ut]{Djoerd Hiemstra}
\ead{d.hiemstra@utwente.nl}
\cortext[cor]{Corresponding Author: Niek Tax, Eindhoven University of Technology, Department of Mathematics and Computer Science, P.O. Box 513, 5600MB Eindhoven, the Netherlands; Email, n.tax@tue.nl; Phone, +31634085760}
\fntext[fn]{Author is affiliated with Eindhoven University of Technology, but this paper was written during his stay at Avanade Netherlands B.V.}
...
\begin{figure}
	\centering
	\includegraphics[scale=0.44]{gfx/bagplots}
