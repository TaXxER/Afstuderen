...
\end{description}
There are several existing metrics that can be used to express the accuracy of a ranking, which we will explore in section \ref{sec:how_to_evaluate_a_ranking}.
\begin{description}
