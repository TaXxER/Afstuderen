...
Ranking is a core problem in the field of information retrieval. The ranking task in information retrieval entails the ranking of candidate documents according to their relevance for a query. Ranking is useful in many other application domains as well, amongst others in drug discovery and to determine the order of maintenance operations\cite{Rudin2009}. Learning-to-Rank has also been argued to be a more fitting approach to recommender systems than rating prediction\cite{Adomavicius2005,McNee2006}.\\
