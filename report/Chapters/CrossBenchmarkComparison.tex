...
\hline 
AdaRank-\acs{MAP} &  &  & Linear Regression &  & \cite{Wang2012, Volkovs2011} \\ 
...
BagBoo &  & \cite{Ganjisaffar2011c} & MCP & \cite{Laporte2013} & \cite{Laporte2013} \\ 
...
CA &  & \cite{Busa-Fekete2013,Tan2013} & Q.D.\acs{KNN} &  & \cite{Wang2013} \\ 
