...
AdaRank-\acs{nDCG} &  & \cite{Busa-Fekete2013,Tan2013} & List\acs{MLE} &  & \cite{Lin2010, Gao2014} \\ 
...
CA &  & \cite{Busa-Fekete2013,Tan2013} & Q.D.\acs{KNN} &  &  \\ 
CCRank &  &  & RandomForest &  & \cite{Gomes2013} \\ 
CoList & \cite{Gao2014} & \cite{Gao2014} & Rank-PMBGP & \cite{Sato2013} & \cite{Sato2013} \\ 
Consistent-RankCosine &  & \cite{Tan2013} & RankAgg\acs{nDCG} &  &  \\ 
...
LambdaMART & \cite{Burges2010} & \cite{Asadi2013a} & SwarmRank &  & \cite{Sato2013} \\ 
