...
\hline 
AdaRank-\acs{MAP} &  &  & Linear Regression &  & \cite{Wang2012} \\ 
AdaRank-\acs{nDCG} &  & \cite{Busa-Fekete2013,Tan2013} & List\acs{MLE} &  &  \\ 
...
BagBoo &  &  & MCP & \cite{Laporte2013} & \cite{Laporte2013} \\ 
Best Single Feature &  &  & MHR &  &  \\ 
...
BoltzRank-Pair & \cite{Volkovs2009} & \cite{Volkovs2009} & OWPC & \cite{Usunier2009} & \cite{Usunier2009} \\ 
BT & \cite{Zhou2008} & \cite{Zhou2008} & PERF-\acs{MAP} &  &  \\ 
C-\acs{CRF} & \cite{Qin2008b} & \cite{Qin2008b} & PermuRank & \cite{Xu2008} & \cite{Xu2008} \\ 
CA &  & \cite{Busa-Fekete2013} & Q.D.\acs{KNN} &  &  \\ 
CCRank &  &  & RandomForest & \cite{Gomes2013} & \cite{Gomes2013} \\ 
CoList & \cite{Gao2014} & \cite{Gao2014} & Rank-PMBGP &  &  \\ 
Consistent-RankCosine &  &  & RankAgg\acs{nDCG} &  &  \\ 
...
Energy\acs{nDCG} & \cite{Freno2011} & \cite{Freno2011} & RankDE &  &  \\ 
FBPCRank & \cite{Lai2011} & \cite{Lai2011} & RankELM (pairwise) & \cite{Zong2013} & \cite{Zong2013} \\ 
FenchelRank & \cite{Lai2013} & \cite{Lai2013} & RankELM (pointwise) & \cite{Zong2013} & \cite{Zong2013} \\ 
FocusedBoost & \cite{Niu2012} & \cite{Niu2012} & RankMGP & \cite{Lin2012} & \cite{Lin2012} \\ 
FocusedNet & \cite{Niu2012} & \cite{Niu2012} & RankNet &  & \cite{Busa-Fekete2013} \\ 
Focused\acs{SVM} & \cite{Niu2012} & \cite{Niu2012} & Rank\acs{RLS} &  &  \\ 
FP-Rank & \cite{Song2013} & \cite{Song2013} & Rank\acs{SVM} &  & \cite{Busa-Fekete2013, Freno2011} \\ 
FRank &  & \cite{Wang2012} & Rank\acs{SVM}-Primal &  &  \\ 
FSMRank & \cite{Lai2013c} & \cite{Lai2013c} & Rank\acs{SVM}-Struct &  &  \\
FSM$^{\acs{MAP}}$ & & & RCP & \cite{Elsas2008} & \cite{Elsas2008} \\ 
GAS-E &  &  & RE-QR & \cite{Veloso2010} & \cite{Veloso2010} \\ 
\acs{GP}Rank &  &  & REG-SHF-SDCG & \cite{Wu2009} & \cite{Wu2009} \\ 
GRank\acs{RLS} & \cite{Pahikkala2010} & \cite{Pahikkala2010} & Ridge Regression &  &  \\ 
Group\acs{CE} & \cite{Lin2011} & \cite{Lin2011} & RSRank &  &  \\ 
Group\acs{MLE} &  &  & SmoothGrad &  &  \\ 
IntervalRank & \cite{Moon2010} & \cite{Moon2010} & SmoothRank & \cite{Chapelle2010} & \cite{Chapelle2010} \\ 
\acs{IP}Rank &  &  & SoftRank &  & \cite{Qin2010b} \\ 
KeepRank & \cite{Chen2009} & \cite{Chen2009} & SoftNet & \cite{Rigutini2008} & \cite{Rigutini2008} \\ 
Kernel-\acs{PCA} &  &  & SparseRank & \cite{Lai2013b} & \cite{Lai2013b} \\ 
KL-\acs{CRF} & \cite{Volkovs2011} &  & \acs{SVD}-RankBoost & \cite{Lin2009} & \cite{Lin2009} \\ 
LAC-MR-OR & \cite{Veloso2008} & \cite{Veloso2008} & \acs{SVM}$^{\acs{MAP}}$ &  & \cite{Wang2012} \\ 
LambdaMART & \cite{Burges2010} & \cite{Asadi2013a} & SwarmRank &  &  \\ 
LambdaNeuralRank & \cite{Papini2012} & \cite{Papini2012} & TGRank &  &  \\ 
LambdaRank &  &  & TM & \cite{Zhou2008} & \cite{Zhou2008} \\ 
