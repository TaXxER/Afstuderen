...
AdaRank-\acs{nDCG} &  & \cite{Busa-Fekete2013,Tan2013} & List\acs{MLE} &  & \cite{Lin2010, Lin2011, Gao2014} \\ 
...
\acs{IP}Rank & \cite{Wang2009b} & \cite{Torkestani2012} & SoftRank &  & \cite{Qin2010b} \\ 
KeepRank & \cite{Chen2009} & \cite{Chen2009} & SortNet & \cite{Rigutini2008} & \cite{Rigutini2008,Freno2011} \\ 
Kernel-\acs{PCA} RankBoost & \cite{Duh2008} & \cite{Duh2008} & SparseRank & \cite{Lai2013b} & \cite{Lai2013b} \\ 
