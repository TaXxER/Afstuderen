...
AdaRank-\acs{MAP} &  &  & Linear Regression &  &  \\ 
AdaRank-\acs{nDCG} &  &  & List\acs{MLE} &  &  \\ 
ADMM &  &  & ListNet &  &  \\ 
...
DCMP & \cite{Renjifo2012}  & \cite{Renjifo2012}  & RankBoost &  &  \\ 
...
FocusedBoost & \cite{Niu2012} & \cite{Niu2012} & Ranking Committee Perceptron & \cite{Elsas2008} & \cite{Elsas2008} \\ 
FocusedNet & \cite{Niu2012} & \cite{Niu2012} & RankMGP &  &  \\ 
Focused\acs{SVM} & \cite{Niu2012} & \cite{Niu2012} & RankNet &  &  \\ 
FP-Rank & \cite{Song2013} & \cite{Song2013} & Rank\acs{RLS} &  &  \\ 
FRank &  &  & Rank\acs{SVM} &  &  \\ 
FSMRank & \cite{Lai2013c} & \cite{Lai2013c} & Rank\acs{SVM}-Primal &  &  \\ 
FSM$^{\acs{MAP}}$ &  &  & Rank\acs{SVM}-Struct &  &  \\ 
...
KL-\acs{CRF} &  &  & \acs{SVD}-RankBoost & \cite{Lin2009} & \cite{Lin2009} \\ 
LAC-MR-OR & \cite{Veloso2008} & \cite{Veloso2008} & \acs{SVM}$^{\acs{MAP}}$ &  &  \\ 
LambdaMART &  &  & SwarmRank &  &  \\ 
LambdaNeuralRank & \cite{Papini2012} & \cite{Papini2012} & TGRank &  &  \\ 
LambdaRank &  &  & TM & \cite{Zhou2008} & \cite{Zhou2008} \\ 
LARF & \cite{Torkestani2012} & \cite{Torkestani2012} & VFLR &  &  \\ 
\end{tabular}}
