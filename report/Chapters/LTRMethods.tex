...
\begin{algorithm}[H]
 ...
 \caption{The ListNet learning algorithm, obtained from \cite{Cao2007}}
 \label{alg:listnet}
\end{algorithm}
...
\begin{algorithm}[H]
 ...
 \caption{The SmoothRank learning algorithm, obtained from \cite{Chapelle2010}}
...
\begin{algorithm}[H]
 ...
 \caption{The FenchelRank learning algorithm, obtained from \cite{Lai2013}}
...
\begin{algorithm}[H]
 ...
 \caption{The FSMRank learning algorithm, obtained from \cite{Lai2013c}}
 \label{alg:fsmrank}
\end{algorithm}
...
\begin{algorithm}
 ...
 \caption{The LRUF algorithm, obtained from \cite{Torkestani2012b}}
 \label{alg:lruf}
\end{algorithm}
