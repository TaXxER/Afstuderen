...
\caption{Features of the LETOR OHSUMED data set, obtained from Qin et al \cite{Qin2010}}
...
\begin{tabular}{p{0.29cm}|p{7.26cm}||p{0.29cm}|p{9.55cm}}
 \textbf{ID} & \textbf{Feature Description} & \textbf{ID} & \textbf{Feature Description}\\ 
 \hline
1 & \acs{TF} of body					& 36& LMIR.JM of body\\
2 &	\acs{TF} of anchor				& 37& LMIR.JM of anchor\\
3 & \acs{TF} of title				& 38& LMIR.JM of title\\
4 & \acs{TF} of \acs{URL}				& 39& LMIR.JM of \acs{URL}\\
5 & \acs{TF} of whole document		& 40& LMIR.JM of whole document\\

6 & \acs{IDF} of body 				& 41& Sitemap based term propagation\\
7 & \acs{IDF} of anchor 				& 42& Sitemap based score propagation\\
8 & \acs{IDF} of title 				& 43& Hyperlink based score propagation: weighted in-link\\
9 & \acs{IDF} of \acs{URL} 			& 44& Hyperlink based score propagation: weighted out-link\\
10& \acs{IDF} of whole document 		& 45& Hyperlink based score propagation: uniform out-link\\

11& \acs{TF-IDF} of body 			& 46& Hyperlink based feature propagation: weighted in-link\\
12& \acs{TF-IDF} of anchor 			& 47& Hyperlink based feature propagation: weighted out-link\\
13& \acs{TF-IDF} of title 			& 48& Hyperlink based feature propagation: uniform out-link\\
14& \acs{TF-IDF} of \acs{URL}			& 49& HITS authority\\
15& \acs{TF-IDF} of whole document	& 50& HITS hub\\
...
19& Document length of \acs{URL}		& 54& Topical HITS authority\\
...
\caption{Features of the LETOR .GOV data set, obtained from Qin et al \cite{Qin2010}}
