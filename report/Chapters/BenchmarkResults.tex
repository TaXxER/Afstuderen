...
LETOR 2.0 baseline results from LETOR website \footnote{http://research.microsoft.com/en-us/um/beijing/projects/letor/letor2.0/baseline.aspx}.
\begin{table}[!h]
\begin{tabular}{l|l|l}
...
Yahoo! Learning to Rank Challenge & Chapelle et al. \cite{Chapelle2011a} & 102 forward references\\
...
\end{table}
Google scholar search results for benchmark data sets without a release/overview paper.
\begin{table}
\begin{tabular}{l|l}
